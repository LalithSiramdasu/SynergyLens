...
const PROJECT_CHAT_TOPICS = {
  ...
  backend: {
    ...
    questions: [
      ...
      "Where is the single model stored?",
      "What feature file is used?",
      "Does this backend use one model?",
      "Where do I customize feature engineering?",
...
const DRUG_INFO_FLOW_MESSAGES = [
  ...
  "Preparing configured structure view",
